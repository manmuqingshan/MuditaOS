      ...
      initializer(std::make_unique<DatabaseInitializer>(this))
{
    ...
    ** (3/user/db). Therefore, we need to check both directories to support both flashing image and updating through updater.
    ** !!! This workaround should be removed with minor patch of updater, however it cannot be released in one package with 
    ** database changes. 
    **/
